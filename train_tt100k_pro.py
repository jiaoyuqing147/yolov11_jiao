...
if __name__ == '__main__':
    model = YOLO(r'ultralytics/cfg/models/11/yolo11-P2-FASFFHead.yaml')#使用这个结构,用大的版本就改字母yolo11l-P2-FASFFHead.yaml# 续训yaml文件的地方改为lats.pt的地址,需要注意的是如果你设置训练200轮次模型训练了200轮次是没有办法进行续训的.
    ...
    model.train(
                ...
                project='runs/tt100k_yolo11_P2-FASFFHead_train',
                name='exp',
                )
