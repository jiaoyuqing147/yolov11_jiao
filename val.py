...
if __name__ == '__main__':
    ...
    model = YOLO(r'runsYOGA/MTSD_yolo11_p345_train/exp/weights/best.pt')
    # model = YOLO(r'runs/tt100k_yolo11_P2-FASFFHead_train/exp/weights/best.pt')
    model.val(data=r"ultralytics/cfg/datasets/MTSD_laptop.yaml",
              split='val',
              imgsz=640,
              batch=12,
              # rect=False,
              ...
              project='valsYOGA/MTSD_yolo11_p345_train',
              name='exp',
              )
