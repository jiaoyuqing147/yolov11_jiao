...
# ================== 路径配置 ==================
IMAGES_DIR = Path(r"E:\DataSets\tt100k_2021\yolojack\images\test")
GT_LABELS = Path(r"E:\DataSets\tt100k_2021\yolojack\labels\test")

MODELS = {
    "baseline": Path(r"E:\DataSets\resultTT100k130test\yolo11_train200"),
    "ours": Path(r"E:\DataSets\resultTT100k130test\yolo11-FASFFHead_P234_OECSOSAInterleave_ciou_bce_train200"),
    "ours_kd": Path(r"E:\DataSets\resultTT100k130test\yolo11-FASFFHead_P234_OECSOSAInterleave_ciou_bce_train_distillation"),
}
...
# 输出目录
OUT_DIR = Path(r"E:\DataSets\resultTT100k130test\compare_3")
