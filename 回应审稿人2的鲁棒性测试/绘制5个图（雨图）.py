...
for item in single_items:
    save_base = OUTPUT_DIR / f"{IMAGE_ID}_{item['name']}_crop_vector_class_color"
...
montage_base = OUTPUT_DIR / f"{IMAGE_ID}_5cols_montage_crop_vector_class_color"
