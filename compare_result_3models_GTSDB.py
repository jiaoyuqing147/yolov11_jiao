...
# ================== 路径配置 ==================
IMAGES_DIR = Path(r"E:\DataSets\GTSDB\yolo43\images\train")
GT_LABELS = Path(r"E:\DataSets\GTSDB\yolo43\labels\train")

MODELS = {
    "baseline": Path(r"E:\DataSets\resultGTSDBtrain\yolo11_train200"),
    "ours": Path(r"E:\DataSets\resultGTSDBtrain\yolo11-FASFFHead_P234_OECSOSAInterleave_ciou_bce_train200"),
    "ours_kd": Path(r"E:\DataSets\resultGTSDBtrain\yolo11-FASFFHead_P234_OECSOSAInterleave_ciou_bce_train_distillation"),
}
...
# 输出目录
OUT_DIR = Path(r"E:\DataSets\resultGTSDBtrain\compare_3")
