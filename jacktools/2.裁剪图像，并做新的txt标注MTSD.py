...
if __name__ == "__main__":
    ...
    # ====== 路径配置 ======
    img_path = r"E:\DataSets\forpaper\ceshiMTSDresult_yolo11_FASFFHead_P234_RCSOSA_wiou_bce_distillation\result_GradCAMPlusPlus.png"
    txt_path = r"E:\DataSets\forpaper\ceshiMTSDresult_yolo11_FASFFHead_P234_RCSOSA_wiou_bce_distillation\p1840115.txt"
    out_dir  = r"E:\DataSets\forpaper\ceshiMTSDresult_yolo11_FASFFHead_P234_RCSOSA_wiou_bce_distillation"

    # img_path = r"E:\DataSets\forpaper\ceshiMTSDresult_yolo11\result_GradCAMPlusPlus.png"
    # txt_path = r"E:\DataSets\forpaper\ceshiMTSDresult_yolo11\p1840115.txt"
    # out_dir  = r"E:\DataSets\forpaper\ceshiMTSDresult_yolo11"


    # ====== ROI 比例（根据原来 640x640 的 ROI 缩放）======
    # 例如原来是：x=285, y=265, w=210, h=75（在 640x640 图上）

#MTSD原图尺寸比较大，用下面这个比例，MTSD进入模型后，图像比例要注意，不是等长等宽！
    x_rel = 130 / 640
    y_rel = 212 / 640
    w_rel = 401 / 640
    h_rel = 180 / 512
